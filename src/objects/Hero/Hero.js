...
export class Hero extends GameObject {
    ...
    step(delta, root) {
      ...
      if(this.isLocked) {
        ...
        if(input?.getActionJustPressed("Space")) {
          ...
          // Look for an object at the next space  (accordig to where Hero is facing)
        ...
        // Attempt to move again if the hero is his position 
        if (hasArrived) {
            this.tryMove(root)
        }
    ...
    tryEmitPosition() {
        if (this.lastX === this.position.x && this.lastY === this.position.x ) {
            return;
        }
    ...
    tryMove(root)  {
        ...
        //validating the next space is free
